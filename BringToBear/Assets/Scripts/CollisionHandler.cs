...
public class CollisionHandler : MonoBehaviour
{
	...
	public static void DoCollision(Rigidbody2D p1, Rigidbody2D p2, float shieldForce, Vector2 impactPoint)
	{
		...
		float p1damagePercentage = 0.1f + p1.GetComponent<PlayerController>().damageTaken / 1200;
		float p2damagePercentage = 0.1f + p2.GetComponent<PlayerController>().damageTaken / 1200;
